...
export const metadata: Metadata = {
  title: 'Konki Burger',
  description: '¡Las mejores hamburguesas de la galaxia!',
};

/**
 * Layout raíz de la aplicación.
 * Este componente envuelve toda la aplicación y es el punto de entrada principal.
 * Configura los proveedores de contexto globales.
...
export default function RootLayout({
  ...
  return (
    ...
    // relacionados con el uso de temas (dark/light) y extensiones de navegador.
    <html lang="es" className="dark" suppressHydrationWarning={true}>
      ...
      <body>
        {/* Proveedor para inicializar y dar acceso a los servicios de Firebase en el cliente. */}
        <FirebaseClientProvider>
          {/* Proveedor del contexto global de la aplicación (carrito, autenticación, etc.). */}
          <AppProvider>
            {/* Componente para sembrar la base de datos con datos iniciales si está vacía. */}
            <DataSeeder />
            {/* El contenido principal de la aplicación se renderiza aquí. */}
            {children}
